...
//        val intent = Intent(context, GoogleProxyActivity::class.java)
//        private val oneTabResult =
...
//                        else -> {
//                            // Shouldn't happen.
//                            Log.d("Sangmeebee", "No ID token!")
//                        }
//                    }
//                } catch (e: ApiException) {
//                    when (e.statusCode) {
//                        CommonStatusCodes.CANCELED -> Log.d("Sangmeebee", "cancel")
//                    }
//                }
//            }
